        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: RichText(
                  text: TextSpan(children: [
                    TextSpan(text: "( إذا أراد الرجل الصلاة فليتوضأ ) وهذا ; لأن الوضوء مفتاح الصلاة قال صلى الله عليه وسلم :", style: AppTextStyles.madReg14(context)),
                    ...
                    TextSpan(text: "فاقتدى بالكتاب في البداية بالوضوء لهذا ، وفي ترك الاستثناء هاهنا وذكره في الحج كما قال الله - تعالى - :", style: AppTextStyles.madReg14(context)),
                    TextSpan(text: " { لتدخلن المسجد الحرام إن شاء الله آمنين } ", style: AppTextStyles.madB14(context, color: Color(AppColors.mainGreen))),
                    TextSpan(text: "، وفي إضمار الحدث ، فإنه مضمر في الكتاب ومعنى قوله :", style: AppTextStyles.madReg14(context)),
                    TextSpan(text: " { إذا قمتم إلى الصلاة } ", style: AppTextStyles.madB14(context, color: Color(AppColors.mainGreen))),
                    TextSpan(text: "من منامكم أو وأنتم محدثون هذا هو المذهب عند جمهور الفقهاء رحمهم الله ، فأما على قول أصحاب الظواهر فلا إضمار في الآية", style: AppTextStyles.madReg14(context)),
            ...
            Container(
              ...
              child: RichText(
                  text: TextSpan(children: [
                    TextSpan(text: "والوضوء فرض سببه القيام إلى الصلاة فكل من قام إليها فعليه أن يتوضأ وهذا فاسد لما روي :", style: AppTextStyles.madReg14(context)),
