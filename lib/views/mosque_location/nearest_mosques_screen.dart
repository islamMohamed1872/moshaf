...
class _MasjidLocatorScreenState extends State<MasjidLocatorScreen> {
  ...
  Future<void> _checkPermissionAndLocate() async {
    ...
    if (permission == LocationPermission.deniedForever) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('تم رفض الإذن بشكل دائم. الرجاء السماح من الإعدادات.')),
      );
      return;
    }
    ...
    try {
      ...
      if (data["status"] == "OK") {
        ...
        for (final mosque in results) {
          ...
          final name = mosque["name"] ?? "مسجد";
          final lat = (location["lat"] as num).toDouble();
          final lng = (location["lng"] as num).toDouble();
          final placeId = mosque["place_id"];
        ...
        if (_nearestMosqueLatLng != null) {
          _markers.add(
            Marker(
              ...
              infoWindow: InfoWindow(title: _nearestMosqueName),
              icon: AppColors.isGoldMode
  ...
  Future<void> _showRouteToNearestMosque() async {
    if (_currentPosition == null || _nearestMosqueLatLng == null) return;
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                gold ? Color(AppColors.goldAccent) : bgColor,
                foregroundColor:
                gold ? Color(AppColors.goldText) : textColor,
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Icon(
                  Icons.my_location,
                  color: gold ? Color(AppColors.goldText) : textColor,
                ),
              ),
            ),
          ),
