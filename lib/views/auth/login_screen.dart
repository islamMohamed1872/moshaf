  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AuthCubit,AuthStates>(
              ...
              body: SafeArea(child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Header(title: "تسجيل الدخول", isDark: isDark,onTap: (){
                      ...
                      ConditionalBuilder(condition: state is !AuthLoginWithEmailAndPasswordLoadingState,
                          builder: (context) => CustomGreenButton(
                            text: "تسجيل الدخول", onTap: () {
                            if (loginFormKey.currentState!.validate()) {
                              cubit.loginWithEmailAndPassword(email: cubit.emailController.text, password: cubit.passwordController.text);
                            }
      ...
      listener: (context, state) {
          if (state is AuthLoginWithEmailAndPasswordSuccessState||state is AuthSignInWithGoogleSuccessState||state is AuthSignInWithAppleSuccessState) {
